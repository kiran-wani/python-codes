...
from galfit import CreateFile, rungalfit
...
CreateFile('gal.fits', [1,93,1,93], model,fout='galfit.input',ZP=26.563,Pimg='psf.fits',scale='0.038 0.038')

#Running galfit...
p,oimg,mods,EV=rungalfit('galfit.input')
...
O=CreateFile('gal.fits', [1,93,1,93], model,fout='galfit.input',ZP=26.563,Pimg='psf.fits',scale='0.038 0.038')
p,oimg,mods,EV=rungalfit('galfit.input')
showme3(oimg)
